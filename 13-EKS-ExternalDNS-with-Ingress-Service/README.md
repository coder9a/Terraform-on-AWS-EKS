...
```yaml
    ...
    external-dns.alpha.kubernetes.io/hostname: dnstest901.mydomain.com, dnstest902.mydomain.com
```
- In your case it is going to be, replace `mydomain` with your domain name
...
- You should see **Record Sets** added for `dnstest901.mydomain.com`, `dnstest902.mydomain.com`
...
```t
# nslookup commands
nslookup dnstest901.mydomain.com
nslookup dnstest902.mydomain.com
```
### Access Application using dnstest1 domain
```t
# HTTP URLs (Should Redirect to HTTPS)
http://dnstest901.mydomain.com/app1/index.html
http://dnstest901.mydomain.com/app2/index.html
http://dnstest901.mydomain.com/
```

### Access Application using dnstest2 domain
```t
# HTTP URLs (Should Redirect to HTTPS)
http://dnstest902.mydomain.com/app1/index.html
http://dnstest902.mydomain.com/app2/index.html
http://dnstest902.mydomain.com/
```
...
- The below records should be deleted automatically
  - dnstest901.mydomain.com
  - dnstest902.mydomain.com
```
...
3. v3-providers.tf
4. v4-kubernetes-app1-deployment.tf
5. v5-kubernetes-app2-deployment.tf
6. v6-kubernetes-app3-deployment.tf
...
- Go to Services -> Route53
- You should see **Record Sets** added for `tfdnstest901.mydomain.com`, `tfdnstest902.mydomain.com`
...
```t
# nslookup commands
nslookup tfdnstest901.mydomain.com
nslookup tfdnstest902.mydomain.com
```
## Step-13: Access Application using tfdnstest1 and tfdnstest2 domains
```t
## Access Application using dnstest1 domain
# HTTP URLs (Should Redirect to HTTPS)
http://tfdnstest901.mydomain.com/app1/index.html
http://tfdnstest901.mydomain.com/app2/index.html
http://tfdnstest901.mydomain.com/

## Access Application using dnstest2 domain
# HTTP URLs (Should Redirect to HTTPS)
http://tfdnstest902.mydomain.com/app1/index.html
http://tfdnstest902.mydomain.com/app2/index.html
http://tfdnstest902.mydomain.com/
```

...
```yaml
    ...
    external-dns.alpha.kubernetes.io/hostname: nlbdns101.mydomain.com
```
...
nslookup nlbdns101.mydomain.com

# Access Application
# Test HTTP URL
http://nlbdns101.mydomain.com

# Test HTTPS URL
https://nlbdns101.mydomain.com
```
...
3. v3-providers.tf
4. v4-kubernetes-app3-deployment.tf
5. v6-acm-certificate.tf
...
resource "kubernetes_service_v1" "myapp3_nlb_service" {
  metadata {
    ...
    annotations = {
      ...
      # External DNS - For creating a Record Set in Route53
      "external-dns.alpha.kubernetes.io/hostname" = "tfnlbdns101.mydomain.com"
    }        
  }
  spec {
    selector = {

...
## Step-03: v2-remote-state-datasource.tf
- **Project Folder:** 03-externaldns-install-terraform-manifests
```t
...
## Step-04: v3-01-generic-variables.tf
- **Project Folder:** 03-externaldns-install-terraform-manifests
```t
...
## Step-06: v4-01-externaldns-iam-policy-and-role.tf
- **Project Folder:** 03-externaldns-install-terraform-manifests
```t
...
## Step-07: v4-02-externaldns-helm-provider.tf
- **Project Folder:** 03-externaldns-install-terraform-manifests
```t
...
## Step-08: v4-03-externaldns-install.tf
- **Project Folder:** 03-externaldns-install-terraform-manifests
```t
...
## Step-09: v4-04-externaldns-outputs.tf
- **Project Folder:** 03-externaldns-install-terraform-manifests
```t

...
```t
# Web URLs
http://ingress-crossns-demo.mydomain.com/app1/index.html
http://ingress-crossns-demo.mydomain.com/app2/index.html
http://ingress-crossns-demo.mydomain.com
```
...
- The below records should be deleted automatically
  - ingress-crossns-demo.mydomain.com
```
...
3. v3-providers.tf
4. v14-acm-certificate.tf

## Step-12: v13-kubernetes-namespaces.tf
- **Project Folder:** 05-ingress-cross-ns-terraform-manifests
```t
...
- **Project Folder:** 05-ingress-cross-ns-terraform-manifests
1. v4-kubernetes-app1-deployment.tf
2. v5-kubernetes-app2-deployment.tf
3. v6-kubernetes-app3-deployment.tf
4. v7-kubernetes-app1-nodeport-service.tf
5. v8-kubernetes-app2-nodeport-service.tf
6. v9-kubernetes-app3-nodeport-service.tf
7. v10-kubernetes-app1-ingress-service.tf
8. v11-kubernetes-app2-ingress-service.tf
9. v12-kubernetes-app3-ingress-service.tf
```t
...
- You should see **Record Set** added for 
  - tfingress-crossns-demo401.mydomain.com
...
```t
# nslookup commands
nslookup tfingress-crossns-demo401.mydomain.com
```
## Step-19: Access Application 
```t
# Access App1
http://tfingress-crossns-demo401.mydomain.com/app1/index.html

# Access App2
http://tfingress-crossns-demo401.mydomain.com/app2/index.html

# Access Default App (App3)
http://tfingress-crossns-demo401.mydomain.com
```
